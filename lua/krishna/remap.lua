...
vim.keymap.set('n', '<M-Up>', [[<Esc><C-w><up>i]])
vim.keymap.set('n', '<M-Down>', [[<Esc><C-w><down>i]])
vim.keymap.set('n', '<M-Left>', [[<Esc><C-w><left>i]])
vim.keymap.set('n', '<M-Right>', [[<Esc><C-w><right>i]])
